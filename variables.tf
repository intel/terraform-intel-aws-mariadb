...
# General Purpose: db.m7i.large, db.m7i.xlarge, db.m7i.2xlarge, db.m7i.4xlarge, db.m7i.8xlarge, db.m7i.12xlarge, db.m7i.16xlarge, db.m7i.24xlarge, db.m7i.48xlarge 
# Memory Optimized: db.r7i.large, db.r7i.xlarge, db.r7i.2xlarge, db.r7i.4xlarge, db.r7i.8xlarge, db.r7i.12xlarge, db.r7i.16xlarge, db.r7i.24xlarge, db.r7i.48xlarge
# See more:
...
variable "db_engine" {
  ...
  type        = string
  validation {
    condition     = contains(["mariadb"], var.db_engine)
    error_message = "The db_engine must be \"mariadb\"."
  }
  default = "mariadb"
}
